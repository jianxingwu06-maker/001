...
class LinkToDxmPipeline:
    def __init__(self, template: Path, output_dir: Path, target_platform: str, accounts: list[str], rules_path: Path | None = None, use_playwright: bool = False):
    ...
    def run(self, links: list[str]) -> dict[str, str]:
        ...
        excel_path = self.output_dir / "dxm_ready_upload.xlsx"
